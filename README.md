...
A Claude Code plugin that bundles four skills for working with [Snowglobe](https://guardrailsai.com/snowglobe), the simulation platform that stress-tests AI agents with synthetic users.
